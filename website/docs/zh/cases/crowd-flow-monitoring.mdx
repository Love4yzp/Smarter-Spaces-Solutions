...
1. 请前往 **SenseCraft AI** 平台：[https://sensecraft.seeed.cc](https://sensecraft.seeed.cc/)。登录后，点击“视觉工作空间”下的“Grove Vision AI V2”并选择**连接**。
...
首先，你需要在 Node-RED 中导入“**人时统计.json**”Flow。
